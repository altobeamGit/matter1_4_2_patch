...
CHIP_ERROR InitCommissionableDataProvider(ExampleCommissionableDataProvider & provider/*, LinuxDeviceOptions & options*/)
{
    ...
    */
        ...
        ChipLogError(Support,  "*** WARNING: Using temporary passcode %u.", static_cast<unsigned>(defaultTestPasscode));
    ...
    */
        ...
        ChipLogError(Support, "*** WARNING: Using temporary test discriminator %u.", static_cast<unsigned>(defaultTestDiscriminator));
    ...
    */
    ...
    return provider.Init(spake2pVerifier, spake2pSalt, spake2pIterationCount, setupPasscode,
                         defaultTestDiscriminator);
}
/*
