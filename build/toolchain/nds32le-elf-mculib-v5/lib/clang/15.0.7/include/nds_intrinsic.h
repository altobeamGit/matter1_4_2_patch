...
enum riscv_csrs {
  ...
  NDS_SBADADDR = 0x143,
  NDS_SIP      = 0x144,
  // Supervisor Indirect CSR Access CSRs
  NDS_SISELECT = 0x150,
  NDS_SIREG    = 0x151,
  NDS_SIREG2   = 0x152,
  NDS_SIREG3   = 0x153,
  ...
  NDS_MTVAL    = 0x343,
  NDS_MIP      = 0x344,
  // Machine Indirect CSR Access CSRs
  NDS_MISELECT = 0x350,
  NDS_MIREG    = 0x351,
  NDS_MIREG2   = 0x352,
  NDS_MIREG3   = 0x353,
...
#define vfwcvtsbf16_bf16m1(src) __riscv_vfwcvtbf16_f_f_v_f32m2((src), 0)
#define vfwcvtsbf16_bf16m2(src) __riscv_vfwcvtbf16_f_f_v_f32m4((src), 0)
#define vfwcvtsbf16_bf16m4(src) __riscv_vfwcvtbf16_f_f_v_f32m8((src), 0)
#define vfncvtbf16s_bf16m1(src) __riscv_vfncvtbf16_f_f_w_bf16m1((src), 0)
#define vfncvtbf16s_bf16m2(src) __riscv_vfncvtbf16_f_f_w_bf16m2((src), 0)
#define vfncvtbf16s_bf16m4(src) __riscv_vfncvtbf16_f_f_w_bf16m4((src), 0)
#endif
...
#define __nds__clz_32(a) \
  (__builtin_riscv_clz_32 (a))
#define __nds__ctz_32(a) \
  (__builtin_riscv_ctz_32 (a))
#define __nds__cpop_32(a) \
  (__builtin_popcount (a))

#if __riscv_xlen == 64
#define __nds__clz_64(a) \
  (__builtin_riscv_clz_64 (a))
#define __nds__ctz_64(a) \
  (__builtin_riscv_ctz_64 (a))
...
#if __riscv_xlen == 32
#define __nds__zip(a) \
  (__builtin_riscv_zip_32 (a))
#define __nds__unzip(a) \
  (__builtin_riscv_unzip_32 (a))
#endif
...
#define __nds__aes32dsi(a, b, c) \
  (__builtin_riscv_aes32dsi_32 (a, b, c))
#define __nds__aes32dsmi(a, b, c) \
  (__builtin_riscv_aes32dsmi_32 (a, b, c))
 #endif

#if __riscv_xlen == 64
#define __nds__aes64ds(a, b) \
  (__builtin_riscv_aes64ds_64 (a, b))
#define __nds__aes64dsm(a, b) \
  (__builtin_riscv_aes64dsm_64 (a, b))
#define __nds__aes64im(a) \
  (__builtin_riscv_aes64im_64 (a))
#endif
...
#define __nds__aes64ks1i(a, b) \
  (__builtin_riscv_aes64ks1i_64 (a, b))
#define __nds__aes64ks2(a, b) \
  (__builtin_riscv_aes64ks2_64 (a, b))
#endif
...
#define __nds__aes32esi(a, b, c) \
  (__builtin_riscv_aes32esi_32 (a, b, c))
#define __nds__aes32esmi(a, b, c) \
  (__builtin_riscv_aes32esmi_32 (a, b, c))
#endif

#if __riscv_xlen == 64
#define __nds__aes64es(a, b) \
  (__builtin_riscv_aes64es_64 (a, b))
#define __nds__aes64esm(a, b) \
  (__builtin_riscv_aes64esm_64 (a, b))
#endif
...
#define __nds__sha512sig0h(a, b) \
  (__builtin_riscv_sha512sig0h_32 (a, b))
#define __nds__sha512sig0l(a, b) \
  (__builtin_riscv_sha512sig0l_32 (a, b))
#define __nds__sha512sig1h(a, b) \
  (__builtin_riscv_sha512sig1h_32 (a, b))
#define __nds__sha512sig1l(a, b) \
  (__builtin_riscv_sha512sig1l_32 (a, b))
#define __nds__sha512sum0r(a, b) \
  (__builtin_riscv_sha512sum0r_32 (a, b))
#define __nds__sha512sum1r(a, b) \
  (__builtin_riscv_sha512sum1r_32 (a, b))
#endif

#if __riscv_xlen == 64
#define __nds__sha512sig0(a) \
  (__builtin_riscv_sha512sig0_64 (a))
#define __nds__sha512sig1(a) \
  (__builtin_riscv_sha512sig1_64 (a))
#define __nds__sha512sum0(a) \
  (__builtin_riscv_sha512sum0_64 (a))
#define __nds__sha512sum1(a) \
  (__builtin_riscv_sha512sum1_64 (a))
#endif
...
#define __nds__prefetch(a, b, c, d) \
  (__builtin_riscv_prefetch (a, b, c, d))
