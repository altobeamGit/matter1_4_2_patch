 ...
 * @b Note:
 *
 * The values written into the destination vector is in Q13 format. When compared with
 * riscv_dsp_cmag_q15, this function delivers higher precision and lower performance.
 */
