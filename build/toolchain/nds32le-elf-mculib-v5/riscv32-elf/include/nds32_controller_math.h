...
#define nds32_clarke_f32 riscv_dsp_clarke_f32

/// Clarke transform of q31 input.
#define nds32_clarke_q31 riscv_dsp_clarke_q31

/// Inverse Clarke transform of floating-point input.
#define nds32_inv_clarke_f32 riscv_dsp_inv_clarke_f32

/// Inverse Clarke transform of q31 input.
#define nds32_inv_clarke_q31 riscv_dsp_inv_clarke_q31

// Park Transform
//
/// Park transform of floating-point input.
#define nds32_park_f32 riscv_dsp_park_f32

/// Park transform of q31 input.
#define nds32_park_q31 riscv_dsp_park_q31

/// Inverse Park transform of floating-point input.
#define nds32_inv_park_f32 riscv_dsp_inv_park_f32

/// Inverse Park transform of q31 input.
#define nds32_inv_park_q31 riscv_dsp_inv_park_q31

// PID Control
//
/// Structure for the floating-point PID Control.
#define nds32_pid_f32_t riscv_dsp_pid_f32_t

/// PID control of floating-point input.
#define nds32_pid_f32 riscv_dsp_pid_f32

/// PID initializatopn control function of floating-point formats.
#define nds32_init_pid_f32 riscv_dsp_init_pid_f32

/// Structure for the Q31 PID Control.
#define nds32_pid_q31_t riscv_dsp_pid_q31_t

/// PID control of Q31 input.
#define nds32_pid_q31 riscv_dsp_pid_q31

/// PID initializatopn control function of Q31 formats.
#define nds32_init_pid_q31 riscv_dsp_init_pid_q31

/// Structure for the Q15 PID Control.
#define nds32_pid_q15_t riscv_dsp_pid_q15_t

/// PID control of Q15 input.
#define nds32_pid_q15 riscv_dsp_pid_q15

/// PID initializatopn control function of Q15 formats.
#define nds32_init_pid_q15 riscv_dsp_init_pid_q15
