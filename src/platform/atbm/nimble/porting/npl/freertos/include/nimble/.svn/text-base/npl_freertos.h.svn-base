...
ble_npl_error_t npl_freertos_mutex_free(struct ble_npl_mutex *mu);
...
void npl_freertos_sem_free(struct ble_npl_sem *sem);
...
void npl_freertos_callout_free(struct ble_npl_callout *co);
